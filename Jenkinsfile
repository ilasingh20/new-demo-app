pipeline {
    ...
    environment {
        ...
        IMAGE_NAME = "ilasingh20/new-demo-app:new-demo-app-v.1.${env.BUILD_NUMBER}"
        ECR_IMAGE_NAME = "${AWS_ACCOUNT_ID}.dkr.ecr.${REGION}.amazonaws.com/new-demo-app:new-demo-app-v.1.${env.BUILD_NUMBER}"
    }
